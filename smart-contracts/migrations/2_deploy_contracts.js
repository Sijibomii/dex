...
module.exports = async function(deployer, _network, accounts) {
  ...
  //add tokens to be recognized by our contract
  await Promise.all([
  ...
  await Promise.all(
   ...
   // so trades can be at different times
  ...
  //create trades
  //create a limit order and create a matching market order so a trade can be executed, increase time by 1 second
  ...
  //create orders
  //so there will be initial/ open orders on the blockchain
  await Promise.all([
